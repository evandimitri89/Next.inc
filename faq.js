...
toggle.addEventListener('click', () => { faqHeader.classList.toggle('darkmode');
    if (!faqHeader.classList.contains('darkmode')) {
        return localStorage.setItem('theme', 'lightmode');
    }
    localStorage.setItem('theme', 'darkmode');
});
...
if (getTheme && getTheme === 'darkmode') {
    ...
    faqHeader.classList.add('darkmode');
}
